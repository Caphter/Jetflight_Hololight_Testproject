...
public class CamNav2 : MonoBehaviour
{
    ...
    void CamMoving()
    {
        ...
        */
        ...
        MoveForward = Input.GetAxis("Vertical") * MoveSpeed * Time.deltaTime * boost;
        MoveSide = Input.GetAxis("Horizontal") * MoveSpeed * Time.deltaTime * boost;
